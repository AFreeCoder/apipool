export default {
    settings: {
      marquee: {
        ...
        description: "Configure scrolling header announcements",
        enabled: "Enable header announcements",
        add: "Add announcement",
        remove: "Remove",
        moveUp: "Move up",
        moveDown: "Move down",
        draftBadge: "Disabled",
        textPlaceholder: "Enter announcement text",
        textRequired: "Enter announcement text",
        tipMultipleSeparator: "Add multiple announcements and adjust their order",
      },
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for APIPool end-user login',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current native usage window (OpenAI Codex/Anthropic session, or Grok request/token utilization) reaches this percent, APIPool temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on APIPool orders; the upstream type is sent as EasyPay type.',
