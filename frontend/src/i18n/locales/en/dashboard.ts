export default {
  ...
  keys: {
    ...
    useKeyModal: {
      openclaw: {
        defaultPathLabel: "Default configuration path",
        generateFailed: "Failed to generate configuration",
        importDescription: "Select an existing OpenClaw configuration to merge APIPool settings",
        modelLabel: "Model",
        providerLabel: "Provider",
        note: "Back up your local configuration before replacing it with the downloaded file",
        parseFailed: "Unable to parse configuration file",
        rememberHint: "The browser can remember the selected file",
        resultHint: "Review the generated configuration, then download and save it",
        selectFile: "Select configuration file",
        unsupported: "OpenClaw configuration is not supported for this group",
      },
      ...
      grok: {
        description:
          'Configure Grok CLI, Claude Code, Codex, or OpenCode to send requests through your APIPool Grok group. Text models use Responses; image/video use Imagine model IDs on media endpoints.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your APIPool Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your APIPool Grok group.',
        configTomlHint:
        ...
        codexConfigTomlHint:
          'Official Codex: wire_api = "responses" only; prefer env_key over experimental_bearer_token; supports_websockets = false for non-OpenAI gateways (APIPool can still accept client WS and bridge to HTTP/SSE). Back up ~/.codex/config.toml before merge.',
        note:
        ...
        codexNote:
          'Export APIPOOL_API_KEY, save config.toml under ~/.codex (mkdir -p ~/.codex). Prefer env_key auth; do not commit secrets.',
        codexNoteWindows:
          'Set $env:APIPOOL_API_KEY, save config.toml under %USERPROFILE%\\.codex. Prefer env_key auth; do not commit secrets.',
      },
      deepseek: {
      ...
      composite: {
        ...
        codexConfigTomlHint: 'Download the model catalog below, save both files under the Codex config directory, and restart Codex.',
        codexNote: 'Export APIPOOL_API_KEY before starting Codex. Model requests are routed by the selected catalog slug.',
      },
      routedCodex: {
        ...
        note: 'Export APIPOOL_API_KEY before starting Codex. The downloaded catalog contains model metadata only, not your API key.',
      },
      codexModelCatalog: {
  ...
  usage: {
    ...
    videoDurationSeconds: 'Video duration (s)',
    videoEffectiveUnitPrice: 'Effective price / s',
