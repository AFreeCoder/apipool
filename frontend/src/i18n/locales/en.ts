  ...
  admin: {
    ...
    accounts: {
      ...
      types: {
        ...
        soraApiKeyHint: 'Connect to another APIPool or compatible API',
      ...
      soraUpstreamBaseUrlHint: 'Upstream Sora service URL (another APIPool instance or compatible API)',
