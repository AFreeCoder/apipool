export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      schedulerScore: {
        baseShort: 'Base',
        stickyShort: 'Max sticky',
        ungrouped: 'Ungrouped',
        hint: 'Displayed as "group / base score / max sticky score". The base score is computed within the current filtered candidate set and includes priority, load, queue depth, error rate, first-token latency, reset window, quota headroom, and related factors. The max sticky score is the score this account may reach when a request hits previous_response_id or session_hash; it does not mean the current list snapshot has already hit sticky routing. Higher scores are preferred.'
      },
      ...
      quotaLimitHint: 'Set daily/weekly/total spending limits (USD). Anthropic API key and Kiro accounts can also configure client affinity. Changing limits won\'t reset usage.',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another APIPool instance.',
      ...
      kiroAuthMethod: 'Kiro auth method',
      kiroSocialAuth: 'Social',
      kiroIDCAuth: 'IdC',
      kiroRefreshToken: 'Kiro refresh token',
      kiroClientId: 'Kiro client ID',
      kiroClientSecret: 'Kiro client secret',
      kiroAuthRegion: 'Kiro auth region',
      kiroApiRegion: 'Kiro API region',
      kiroMachineId: 'Kiro machine ID',
      kiroMachineIdHint: 'Leave empty to auto-generate from refresh token',
      kiroProfileArn: 'Kiro profile ARN',
    ...
    ops: {
      ...
      requestLog: {
        title: 'User Request Detail Logs',
        targetUser: 'Target user ID: {id}',
        recording: 'Recording',
        recordingShort: 'Req log',
        notRecording: 'Not recording',
        enableMenu: 'Start recording',
        disableMenu: 'Stop recording',
        viewMenu: 'View request logs',
        enable: 'Start 30 min recording',
        disable: 'Stop recording',
        download: 'Download NDJSON',
        session: 'Session',
        selectSession: 'Select historical session',
        startedAt: 'Started',
        expiresAt: 'Expires',
        ...
        memoryPrecheck: 'Redis memory precheck: {used} / {max} ({percent}%)',
        memoryGuarded: 'Memory guard active',
        retentionHint: 'Only the most recent segment is retained. If data is truncated or dropped, narrow the window or download soon.',
        complianceNotice: 'This records the user full request and response plaintext for troubleshooting only',
        reasonPlaceholder: 'Enter troubleshooting reason (required)',
        confirmThirtyMinutes: 'Confirm the 30 minute maximum; recording stops automatically',
        forceRestart: 'If already recording, stop the old session and start a new one',
        enabling: 'Starting...',
        disabling: 'Stopping...',
        enabledSuccess: 'Request log recording started',
        disabledSuccess: 'Request log recording stopped',
        failedToLoad: 'Failed to load request log status',
        failedToLoadItems: 'Failed to load request log items',
        failedToLoadDetail: 'Failed to load request log detail',
        failedToEnable: 'Failed to start request log recording',
        failedToDisable: 'Failed to stop request log recording',
        failedToDownload: 'Failed to create download link',
        noItems: 'No request items in this session',
        detail: 'Detail',
        ...
        copy: 'Copy',
        copied: 'Copied',
        bodyTruncated: 'Content was truncated by the backend',
        columns: {
          time: 'Time',
          model: 'Model / Path',
          status: 'Status',
      ...
      settings: {
        ...
        ignoredErrorCodes: 'Ignored Error Code Whitelist',
        ignoredErrorCodesHint: 'Matches exact error codes. Supports comma, semicolon, or newline separators. Only affects future error log writes and does not modify historical data.',
        ignoredErrorCodesPlaceholder: 'API_KEY_QUOTA_EXHAUSTED\nAPI_KEY_EXPIRED\nINVALID_API_KEY',
        autoRefresh: 'Auto Refresh',
        enableAutoRefresh: 'Enable auto refresh',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for APIPool end-user login',
      ...
      marquee: {
        ...
        moveDown: 'Move down',
        remove: 'Remove',
        textRequired: 'Fill in the marquee message or remove the blank message.',
      },
      payment: {
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to APIPool',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">APIPool is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of APIPool, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to APIPool',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the APIPool AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
