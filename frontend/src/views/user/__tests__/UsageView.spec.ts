...
describe('user UsageView', () => {
  ...
  it('exports csv with current filters and without admin-only fields', async () => {
    ...
    expect(csvContent.slice(1)).toBe([
      'Time,API Key Name,Model,Reasoning Effort,Inbound Endpoint,IP Address,Type,Billing Mode,Video Count,Video Resolution,Video Duration (s),Input Tokens,Output Tokens,Cache Read Tokens,Cache Creation Tokens,Rate Multiplier,Billed Cost,Original Cost,First Token (ms),Duration (ms)',
      '2026-03-08T00:00:00Z,demo-key,gpt-5.4,"\'-",,203.0.113.10,Sync,Token,0,,,4057,101,278272,4,1,0.09288300,0.09288300,12,345',
    ].join('\n'))
