...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/AFreeCoder/apipool/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/AFreeCoder/apipool/blob/main/docs/legal/admin-compliance.en.md"
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 APIPool 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the APIPool Deployment and Operation Compliance Commitment"
