...
func TestNormalizeOpenAIPassthroughOAuthBody_CompactDeletesStoreAndStreamButStillNormalizesInput(t *testing.T) {
	body := []byte(`{"model":"gpt-5.4","stream":true,"store":true,"input":"compact me"}`)
