...
func (s *OpenAIGatewayService) calculateOpenAIRecordUsageCost(
	...
	gptImage2TokenBilling := result != nil && result.ImageCount > 0 && s.shouldUseGPTImage2TokenBilling(billingModels)
	...
	for _, candidate := range billingModels {
		...
		if err == nil {
			if gptImage2TokenBilling && cost != nil && cost.BillingMode == "" {
