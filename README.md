...
- OpenAI-compatible Videos：`/v1/videos/generations`、`/videos/generations`、`/v1/videos/{request_id}`、`/videos/{request_id}`
- 初始文本模型：`grok-4.3`、`grok-build-0.1`、`grok-4.20-0309-reasoning`、`grok-4.20-0309-non-reasoning`、`grok-4.20-multi-agent-0309`
